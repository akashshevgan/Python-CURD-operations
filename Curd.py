...
class Database:
    ...
    def insertRecord():
        ...
        try:
            ...
            mycursor.execute("insert into student values(1,'Akash',80),(2,'Ram',89),(3,'Suraj',90)")
    ...
    def updateRec():
        ...
        try:
            mycursor = database.cursor()
            mycursor.execute(
                "UPDATE student SET name='Ramu', marks=100 WHERE roll=1")  # Execute SQL Query to update record
            database.commit()  # Commit is used for your changes in the database
...
if __name__ == '__main__':
    print(
        'Available Options: 1 : Create table, 2 : insert record, 3 : display records, 4 : update record 5 : delete record')
